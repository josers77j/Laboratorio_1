...
<div class="p-4 p-md-5 mb-4 mt-5 rounded text-bg-dark">
  ...
  <div class="card-body">
    ...
    <h5 class="card-title fs-1">+320</h5>
    <p class="card-text">Totales</p>
 
    
  </div>
</div>
<div class="card text-white bg-secondary col-3 m-3">
  <div class="card-header">numero de clientes</div>
  <div class="card-body">
    <i class="fas fa-users fs-1"></i>
    <h5 class="card-title fs-1">+89</h5>
    <p class="card-text">Del año anterior.</p>
  </div>
</div>
<div class="card text-white bg-success col-3 m-3">
<div class="card-header">numero de clientes</div>
  <div class="card-body">
    <i class="fas fa-users fs-1"></i>
    <h5 class="card-title fs-1">+10</h5>
    <p class="card-text">Del mes anterior.</p>
</div>
</div>
<div class="card text-white bg-danger col-3 m-3">
...
<div class="card text-dark bg-warning col-3 m-3">
<div class="card-header">numero de visitas</div>
  <div class="card-body">
  <i class="fas fa-walking fs-1"></i>
    <h5 class="card-title fs-1">+175</h5>
    <p class="card-text">Del año anterior.</p>
</div>
</div>
<div class="card text-dark bg-info col-3 m-3">
<div class="card-header">numero de visitas</div>
  <div class="card-body">
  <i class="fas fa-walking fs-1"></i>
    <h5 class="card-title fs-1">+405</h5>
